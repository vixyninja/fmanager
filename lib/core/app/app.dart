        ...
        child: GetMaterialApp(
          ...
          onInit: () {
            SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
              statusBarColor: Get.find<ThemeLogic>().theme == 'dark'
                  ? Colors.black
                  : Colors.white,
              statusBarBrightness: Get.find<ThemeLogic>().theme == 'dark'
                  ? Brightness.light
                  : Brightness.dark,
              statusBarIconBrightness: Get.find<ThemeLogic>().theme == 'dark'
                  ? Brightness.light
                  : Brightness.dark,
              systemNavigationBarColor: Get.find<ThemeLogic>().theme == 'dark'
                  ? Colors.black
                  : Colors.white,
              systemNavigationBarIconBrightness:
                  Get.find<ThemeLogic>().theme == 'dark'
                      ? Brightness.light
                      : Brightness.dark,
            ));
          },
